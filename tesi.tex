...
\begin{document}
  ...
  \input{argoments/Introduzione.tex}
  \input{argoments/Costi.tex}
  \input{argoments/MongoDb.tex}
  \input{argoments/Oracle.tex}
  \input{argoments/CouchDb.tex}
